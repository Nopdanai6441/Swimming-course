...
<body>
	...
	if (isset($_POST['Submit'])) {
		...
		$id = $_GET['id'];
			 ...
			 $sql = "INSERT INTO `memnext` (`userid`, `namenext`, `phone`, `timenext`, `numm`) VALUES ('".$_GET['id']."', '" . $_POST['name'] . "', '" . $_POST['phone'] . "', '" .$date. "', '3')";
...
<?php while ($row = mysqli_fetch_array($result)) {?>
					...
					<div class="wrap-input100 validate-input" data-validate="กรุณากรอกข้อมูล">
						<?php $datea=date_format(new datetime ($row["day3"]),"d-m-Y")  ?>
						<input class="input100" type="text" name="day3" value="<?=$datea?>">
