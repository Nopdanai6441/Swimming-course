...
<body>
  <a href='../index.php' class='btn btn-secondary btn-sm'> ย้อนกลับ </a>
  <div class="container">
    <?php
    ...
    echo  "<th>เช็คชื่อ</th>";
    echo "<th>เลื่อนนัด</th>";
    echo "</thead>";
    echo "<tbody>";
    while ($row = mysqli_fetch_array($result)) {
      echo "<tr>";
      echo "<td> 1 <br></td>";
      if($row["day1"]=='0000-00-00 00:00:00'){echo "<td> 00-00-0000 00:00 <br></td>";}else{echo "<td>" .date_format(new datetime ($row["8"]),"d-m-Y H:i"). "<br></td>";}
      if($row["14"]=='true')
      {
      echo "<td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ma <br></td>";
      ...
      echo "<td><a class='btn btn-secondary btn-sm' > เรียนแล้ว </a></td>";
        }else{echo "<td><a href='../Login_v16/settime next1.php?id=$row[memid]' class='btn btn-secondary btn-sm' > เลื่อนนัด </a></td>";}
      echo "</tr>";
      echo "<tr>";
      echo "<td> 2 <br></td>";
      if($row["day1"]=='0000-00-00 00:00:00'){echo "<td> 00-00-0000 00:00 <br></td>";}else{echo "<td>" .date_format(new datetime ($row["9"]),"d-m-Y H:i"). "<br></td>";}
      if($row["15"]=='true')
      {
      echo "<td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ma <br></td>";
    ...
    if($row['check2']=='true')
        {
      echo "<td><a class='btn btn-secondary btn-sm' > เรียนแล้ว </a></td>";
        }else{echo "<td><a href='../Login_v16/settime next2.php?id=$row[memid]' class='btn btn-secondary btn-sm' > เลื่อนนัด </a></td>";}
      echo "</tr>";
      echo "<tr>";
      echo "<td> 3 <br></td>";
      if($row["day1"]=='0000-00-00 00:00:00'){echo "<td> 00-00-0000 00:00 <br></td>";}else{echo "<td>" .date_format(new datetime ($row["10"]),"d-m-Y H:i"). "<br></td>";}
      if($row["16"]=='true')
      {
      echo "<td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ma <br></td>";
    ...
    if($row['check3']=='true')
      {
        echo "<td><a class='btn btn-secondary btn-sm' > เรียนแล้ว </a></td>";
      }else{echo "<td><a href='../Login_v16/settime next3.php?id=$row[memid]' class='btn btn-secondary btn-sm' > เลื่อนนัด </a></td>";}
      echo "</tr>";
      echo "<tr>";
      echo "<td> 4 <br></td>";
      if($row["day1"]=='0000-00-00 00:00:00'){echo "<td> 00-00-0000 00:00 <br></td>";}else{echo "<td>" .date_format(new datetime ($row["11"]),"d-m-Y H:i"). "<br></td>";}
      if($row["17"]=='true')
      {
      echo "<td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ma <br></td>";
    ...
    if($row['check4']=='true')
      {
        echo "<td><a class='btn btn-secondary btn-sm' > เรียนแล้ว </a></td>";
      }else{echo "<td><a href='../Login_v16/settime next4.php?id=$row[memid]' class='btn btn-secondary btn-sm' > เลื่อนนัด </a></td>";}
      echo "</tr>";
      echo "<tr>";
      echo "<td> 5 <br></td>";
      if($row["day1"]=='0000-00-00 00:00:00'){echo "<td> 00-00-0000 00:00 <br></td>";}else{echo "<td>" .date_format(new datetime ($row["12"]),"d-m-Y H:i"). "<br></td>";}
      if($row["18"]=='true')
      {
      echo "<td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ma <br></td>";
    ...
    if($row['check5']=='true')
      {
        echo "<td><a class='btn btn-secondary btn-sm' > เรียนแล้ว </a></td>";
      }else{echo "<td><a href='../Login_v16/settime next5.php?id=$row[memid]' class='btn btn-secondary btn-sm' > เลื่อนนัด </a></td>";}
      echo "</tr>";
      echo "<tr>";
      echo "<td> 6 <br></td>";
      if($row["day1"]=='0000-00-00 00:00:00'){echo "<td> 00-00-0000 00:00 <br></td>";}else{echo "<td>" .date_format(new datetime ($row["13"]),"d-m-Y H:i"). "<br></td>";}
      if($row["19"]=='true')
      {
      echo "<td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ma <br></td>";
    ...
    if($row['check6']=='true')
      {
        echo "<td><a class='btn btn-secondary btn-sm' > เรียนแล้ว </a></td>";
      }else{echo "<td><a href='../Login_v16/settime next6.php?id=$row[memid]' class='btn btn-secondary btn-sm' > เลื่อนนัด </a></td>";}
      echo "</tr>";
    }
    echo "</tbody>";
    echo "</table>";
