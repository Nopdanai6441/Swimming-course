...
<body>
  ...
  <div class="container">
    ...
    $query = "SELECT * FROM member where status = 'm'";
    ...
    echo  "<th>ชื่อ</th>";
    echo  "<th>นามสกุล</th>";
    echo  "<th>ครั้งที่1</th>";
    echo  "<th>ครั้งที่2</th>";
    echo  "<th>ครั้งที่3</th>";
    echo  "<th>ครั้งที่4</th>";
    echo  "<th>ครั้งที่5</th>";
    echo  "<th>ครั้งที่6</th>";
    echo  "<th>นัดเรียน</th>";
    echo "</thead>";
    echo "<tbody>";
    while ($row = mysqli_fetch_array($result)) {
      ...
      echo "<td><a href='full-screen-table memadmin.php?id=$row[memid]' class='btn btn-secondary btn-sm' > แก้ไข </a></td>";
      echo "<td><a href='../Login_v16/settime.php?id=$row[memid]' class='btn btn-secondary btn-sm' > แก้ไขทั้งหมด </a></td>";
      echo "</tr>";
    }
    echo "</tbody>";
    echo "</table>";
